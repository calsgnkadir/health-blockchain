...
===================================================================
Record attachments (a scanned consent form, a worksheet) are kept inside the same tamper-evident
...
for one practice — a distributed content network was never the fit; the fold
